...
test("PDF text editor is exposed as a dedicated tool with history navigation", async () => {
  ...
  assert.match(navigation, /<div className="sidebar-header">/);
  ...
  assert.match(styles, /\.sidebar-collapsed \.pdf-tools-subnav \{[^}]*width: min\(280px, calc\(100vw - 112px\)\)[^}]*overflow: visible/);
  assert.match(styles, /\.sidebar-collapsed \.sidebar \.pdf-tools-subnav \.nav-copy \{[^}]*display: flex[^}]*overflow: visible/);
  assert.match(styles, /\.sidebar-collapsed \.pdf-tools-subnav \.nav-copy strong[^}]*text-overflow: clip/);
  ...
  assert.match(styles, /\.sidebar-collapsed \.sidebar \.sidebar-header \{[^}]*justify-content: center/);
  assert.match(styles, /\.sidebar-collapse \{[^}]*width: 38px[^}]*height: 38px[^}]*border-radius: 50%/);
  assert.match(styles, /\.sidebar-collapse:focus-visible \{[^}]*box-shadow: none/);
