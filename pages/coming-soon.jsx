import { AudioLines, Captions, Code2, FileMusic, GalleryHorizontalEnd, ImagePlus, PenLine, ScanLine, SlidersHorizontal, WandSparkles } from "lucide-react";
import Link from "next/link";
import { AppShell } from "../components/app-shell.jsx";

const plannedTools = [
  ["Audio extractor", "Pull a clean audio track from any supported video file.", FileMusic, "Beta", "/audio-extractor"],
  ["Mock API", "Create JSON REST mocks for frontend testing in Browser mode or on localhost.", Code2, "Beta", "/mock-api"],
...
export default function ComingSoonPage() {
  return <AppShell>
    <div className="page-heading"><div><div className="section-kicker"><span className="kicker-line" /> Planned tools</div><h1>More tools, on the way</h1><p>We are building a wider set of practical media utilities. Beta tools are available for testing while the remaining tools are planned.</p></div><div className="heading-note"><WandSparkles size={16} /><span>{plannedTools.length} tools planned or in beta</span></div></div>
