...
export default function TermsPage() {
  return <AppShell>
    <article className="legal-document">
      ...
      <p className="legal-intro">These terms describe the basic rules for using {PRODUCT_NAME} and its local processing agent.</p>
      ...
      <p>You may use {PRODUCT_NAME} only for lawful purposes and only with files you are authorized to process. You are responsible for reviewing generated files before relying on or sharing them.</p>
      ...
      <p>{PRODUCT_NAME} is provided on an as-available basis. Processing may fail, produce an imperfect result, or be unavailable because of file contents, system dependencies, connectivity, or maintenance. Keep an original copy of important files.</p>
