...
export function MockApiPage() {
  ...
  return <AppShell><article className="mock-api-page">
    <header className="mock-api-hero"><div className="section-kicker"><span className="kicker-line" /> Build a mock API</div><h1>Free Mock API Generator for Frontend Testing</h1><p>Create mock REST APIs with JSON responses for frontend development, demos, and API testing. Run them on the website Server or through a private Local agent on your computer.</p><MockDiagram /><div className="mock-api-summary"><strong>Mock REST API testing.</strong> Choose whether your saved APIs run on the website Server or through the authorized Local agent.</div></header>
