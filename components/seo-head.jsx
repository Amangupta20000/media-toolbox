...
import { absoluteSiteUrl, AUTHOR_EMAIL, AUTHOR_ID, AUTHOR_NAME, metadataForPathname, normalizeSitePath, SITE_URL } from "../lib/site-metadata.js";
...
export function SeoHead() {
  ...
  const pageLabel = metadata.breadcrumbLabel || metadata.title.replace(/\s*\|\s*Media Toolbox$/, "");
  ...
  const website = {
    ...
    url: SITE_URL,
    name: "Media Toolbox",
    description: "Private desktop tools for practical PDF and media file work through the Media Toolbox Local agent.",
  ...
  const application = {
    ...
    description: "Private desktop tools for converting images, repairing videos, editing PDFs, and compressing documents through the Local agent.",
  ...
  return <Head>
    ...
    <meta name="publisher" content="Media Toolbox" />
    ...
    <meta property="og:image:alt" content="Media Toolbox app logo" />
    ...
    <meta name="twitter:image:alt" content="Media Toolbox app logo" />
