...
export function AnalyticsRuntime() {
  ...
  return <aside className={`analytics-consent-banner ${bannerOpen ? "is-open" : "is-hidden"}`} role="region" aria-hidden={!bannerOpen} aria-labelledby="analytics-consent-title" aria-describedby="analytics-consent-description">
    ...
    <p id="analytics-consent-description">We use Google Analytics to understand how visitors use NativeMedia Agent and improve the website. We do not send your files or directly identifying personal data to Google Analytics.</p>
