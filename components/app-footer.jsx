  ...
  return <footer className="app-footer">
    <div className="app-footer-main">
      ...
      <nav aria-label="Legal and site links">
        <Link href="/about" title="About NativeMedia Agent">About</Link>
        <Link href="/guides" title="Practical guides">Guides</Link>
        ...
        <Link href="/local-agent" title="Check Local agent connection">Check Local agent connection</Link>
        <Link href="/browser-vs-local-agent" title="Browser vs Local agent">Browser vs Local agent</Link>
