...
export const SEO_BY_ROUTE = {
  ...
  "/mock-api": {
    title: `Build a Server or Local Mock API for Frontend Testing | ${PRODUCT_NAME}`,
    description: `Create JSON REST mock APIs for frontend development. Choose Server hosting for a callable deployed URL or Local agent hosting for a private localhost API.`,
    keywords: "mock API for frontend testing, server REST API, local REST API, JSON mock server, dummy API, localhost API, NativeMedia Agent",
