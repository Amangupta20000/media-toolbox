...
export const SEO_BY_ROUTE = {
  ...
  "/svg-to-png": {
    ...
    description: `Convert SVG files or pasted SVG code to PNG with transparent, solid, or gradient backgrounds. Browser mode supports 1×–4× without uploading; Local agent also supports custom output dimensions.`,
    keywords: "free SVG to PNG converter, convert SVG to PNG, rasterize SVG, transparent PNG, gradient PNG background, custom PNG size, Figma SVG export, NativeMedia Agent",
    breadcrumbLabel: "SVG to PNG converter",
  },
  "/video-repair": {
    title: `Private Video Repair Tool | ${PRODUCT_NAME}`,
    description: `Repair damaged MP4, MOV, M4V, MKV, WebM, AVI, MPEG, and MPG videos locally with layered recovery and optional reference support. NativeMedia Agent leaves your original video untouched.`,
    keywords: "private video repair tool, repair damaged MP4, fix damaged video, recover video, local video repair, NativeMedia Agent",
