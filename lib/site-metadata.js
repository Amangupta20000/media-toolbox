...
export const SEO_BY_ROUTE = {
  ...
  "/mock-api": {
    title: `Build a Local Mock API for Frontend Testing | ${PRODUCT_NAME}`,
    description: `Create JSON REST mock APIs for frontend development. Simulate GET, POST, PUT, PATCH, and DELETE in Browser mode or host a validated localhost API with the Local agent.`,
    keywords: "mock API for frontend testing, local REST API, JSON mock server, dummy API, localhost API, NativeMedia Agent",
