...
export const SEO_BY_ROUTE = {
  "/image-converter": {
    ...
    description: `Convert JPG, PNG, HEIC, TIFF, GIF, and BMP images with the ${PRODUCT_NAME} on macOS, Windows, or Linux, using batch settings while preserving pixel dimensions.`,
  ...
  "/video-repair": {
    ...
    description: `Repair damaged or unreadable MP4, MOV, MKV, and WebM videos with the ${PRODUCT_NAME} on macOS, Windows, or Linux, using layered recovery and reference support.`,
  ...
  "/pdf-editor": {
    ...
    description: `Edit PDFs with the ${PRODUCT_NAME} on macOS, Windows, or Linux by merging documents, reordering pages, adding blank pages, images, and text boxes without overwriting sources.`,
  ...
  "/pdf-compressor": {
    ...
    description: `Compress PDF files with the ${PRODUCT_NAME} on macOS, Windows, or Linux using selectable quality profiles, image optimization, and size controls without changing the original.`,
