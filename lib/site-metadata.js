...
export const SEO_BY_ROUTE = {
  ...
  "/svg-to-png": {
    ...
    description: `Convert SVG files or pasted SVG code to PNG with the ${PRODUCT_NAME} on macOS, Windows, or Linux. Export at 1×, 2×, 3×, 4×, or a custom size with a transparent, solid, or gradient background and adjustable opacity; Browser mode supports 1×–4×, while Custom uses desktop processing.`,
    keywords: "SVG to PNG converter, convert SVG to PNG, rasterize SVG, transparent PNG, gradient PNG background, custom PNG size, Figma SVG export, NativeMedia Agent",
  ...
  "/pdf-text-editor": {
    ...
    description: `Edit searchable and scanned PDF text with the ${PRODUCT_NAME} on macOS, Windows, or Linux. Browser mode safely replaces embedded text in one PDF up to 25 MB and 100 pages, while Local agent adds OCR, formatting, and placement controls.`,
  ...
  "/pdf-compressor": {
    ...
    description: `Compress PDF files with the ${PRODUCT_NAME} on macOS, Windows, or Linux using Local agent quality profiles, or Browser mode with the Balanced profile for quick PDFs up to 10 MB, without changing the original.`,
