...
import { MAX_PDF_BYTES, MAX_PDF_TOTAL_BYTES } from "./pdf-limits.js";
...
export const config = {
  appName: process.env.NEXT_PUBLIC_APP_NAME || "NativeMedia Agent",
  ...
  pdfMaxBytes: Math.min(numberFromEnv("PDF_MAX_BYTES", MAX_PDF_BYTES), MAX_PDF_BYTES),
  pdfTotalMaxBytes: Math.min(numberFromEnv("PDF_TOTAL_MAX_BYTES", MAX_PDF_TOTAL_BYTES), MAX_PDF_TOTAL_BYTES),
...
export const paths = {
  ...
  workerLock: path.join(config.dataDir, "worker.lock"),
};
