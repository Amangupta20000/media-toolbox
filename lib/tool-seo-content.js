export const TOOL_SEO_CONTENT = {
  "/image-converter": {
    ...
    intro: "Media Toolbox converts common image formats without changing the source image’s pixel dimensions. It supports JPG, PNG, HEIC, TIFF, GIF, and BMP output, with per-image settings for batch work.",
    steps: [
  ...
  "/local-agent": {
    name: "the Media Toolbox local agent",
    intro: "The optional Local agent runs supported media and PDF jobs on your own Mac, Windows, or Linux computer. It is useful when files should stay on the device throughout processing.",
    steps: [
