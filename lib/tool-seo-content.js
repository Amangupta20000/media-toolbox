export const TOOL_SEO_CONTENT = {
  ...
  "/svg-to-png": {
    ...
    intro: "Convert vector SVG artwork into PNG images at 1×, 2×, 3×, 4×, or a custom size. Upload an SVG file or paste SVG code, then choose a transparent or solid colour background before creating a new PNG.",
    steps: [
      "Upload an SVG file or paste SVG markup into the converter.",
      "Choose 1×, 2×, 3×, 4×, or Custom and enter the output width and height.",
      "Keep the background transparent or select a solid colour with the colour picker.",
      "Start the conversion, review the PNG preview, and download the new file.",
    ],
    trust: [
      "SVG input is sent only to the Local agent on this computer for rasterization.",
      "The converter validates SVG markup and blocks scripts, external resources, and embedded active content.",
      "The original SVG is never overwritten; the Local agent creates a separate PNG result.",
    ],
    faqs: [
      ...
      ["Can the PNG background be transparent?", "Yes. Transparent is the default. You can also choose a solid background colour with the colour picker when the PNG needs to display consistently on light or dark surfaces."],
      ["Where is the SVG converted?", "The conversion runs through the connected Local agent on your Mac, Windows, or Linux computer. The website sends the source to that local agent, not to a server processing worker."],
    ],
  },
  "/video-repair": {
