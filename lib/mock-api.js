...
function applyEndpointRequest(project, { method = "GET", pathname = "/", body, headers = {} } = {}) {
  ...
  const result = applyCollectionRequest(project, { method: upperMethod, pathname, body, collectionName, singleRecordResponse: endpoint.singleRecordResponse, responseNodePath: endpoint.responseNodePath });
